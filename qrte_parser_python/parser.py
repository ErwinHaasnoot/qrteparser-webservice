...
class QRTEParserLogger:
    ...
    @classmethod
    def warning(cls,msg):
        cls(msg="[WARNING] %s" % msg,level = cls.LEVEL_WARNING)
...
class QRTEMarkUpNode():
    ...
    def writeData(self,file,postfix):
        ...
        global_data = {col:'' for col in columns}
    ...
    def create(node, file):
        ...
        for header in headers:
            ...
            #     if ~( put_key in ignore_columns or put_val in ignore_columns or put_key == '' or put_val == ''):
    ...
    def getTopLevelNode(cls):
        return dict(childs=[],columns={},amount=1,addIndex=0,name="topLevelId")
