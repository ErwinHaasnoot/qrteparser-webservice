class QRTEParserException(Exception):
    ...
    ERR_MSG_VERBOSE = {
        ...
        ERR_MISSING_COLUMNS: 'The specified column seems to be missing from the data file. Please check if this column has been pre-defined in the Embedded Data block in the Survey Flow.cd ',
