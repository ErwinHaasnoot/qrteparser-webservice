...
def generate_system_filename(instance, old_filename):
    return 'static/in/' + str(instance.name_system) + '.csv'
...
class DataFile(models.Model):
    ...
    datafile = models.FileField(upload_to=generate_system_filename)

    email = models.TextField(help_text="Email address tc do which notification should be sent about finished File")
    ...
    def generate_out_name(self, filename):
        return 'static/out/'
